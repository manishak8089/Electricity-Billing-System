...
<script>
    document.getElementById('units').addEventListener('input', function() {
        ...
        var amount = calculateAmount(units);
        document.getElementById('amount').value = amount.toFixed(2); // Format to two decimal places
    });

    function calculateAmount(units) {
        // Implement your calculation logic here based on units
        // For example:
        var ratePerUnit = 10; // Assuming rate per unit is $10
        var amount = units * ratePerUnit;
        return amount;
    }
</script>
